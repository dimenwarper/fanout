...
Architecture: 64 -> 13 (ELU, alpha=1.0) -> 10  (1,072 parameters)
  - W1: (64, 13), b1: (13,)
  - W2: (13, 10), b2: (10,)
...
def top5_accuracy() -> dict:
    """Return weight dict for 64->13->10 MLP (top-5 metric)."""
    rng = np.random.RandomState(42)
    return {
        "W1": rng.randn(64, 13).astype(np.float32) * 0.1,
        "b1": np.zeros(13, dtype=np.float32),
        "W2": rng.randn(13, 10).astype(np.float32) * 0.1,
